...
| **Dimensions** | **14,783** Cells × **17,374** Genes |
...
└── Stage_Two/
    ...
    ├── data/
    │   ├── raw/
    │   │   └── bone_marrow.h5ad         # Raw counts (User provided)
    │   └── processed/
    │       └── bone_marrow_processed.h5ad # Final annotated object
    ├── figures/
    │   ├── _QC_metrics.png              # Violin plots of n_genes, counts, MT%
    │   ├── _QC_scatter.png              # Scatter plot of MT vs Counts
    │   ├── _dispersion.png              # Highly Variable Genes plot
    │   ├── _variance_ratio.png          # PCA Variance
    │   ├── _QC_check.png                # UMAP colored by QC metrics
    │   ├── _Leiden_Resolutions.png      # UMAP of clusters (0.2 - 2.0)
    │   ├── _Dotplot_CellType.png        # Expression of marker genes
    │   └── _Final_Annotation_UMAP.png   # Final annotated UMAP
    └── bone_marrow_analysis.md